...
import { FatIMTPoseidon2Test__factory, FatIMTPoseidonWriteEvent__factory } from "../typechain-types"
...
task("deploy:imt-poseidon-test", "Deploy an IMT contract for testing a library")
    ...
    .setAction(async ({ logs, library: libraryName, arity }, { ethers }): Promise<any> => {
        ...
        })) as FatIMTPoseidonWriteEvent__factory
