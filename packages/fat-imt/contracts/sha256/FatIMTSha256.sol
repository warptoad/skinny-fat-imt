...
library FatIMTSha256 {
    ...
    function update(
        ...
        return InternalFatIMTEvent._update(self, oldLeaf, newLeaf, index, proofSiblings, hasher);
    }
    ...
    function updateMany(
        ...
        return InternalFatIMTEvent._updateMany(self, oldLeaves, newLeaves, leafIndexes, proofSiblings, hasher);
    }
